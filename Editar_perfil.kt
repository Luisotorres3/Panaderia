...
class Editar_perfil : Fragment() {
    ...
    private lateinit var email_new: com.google.android.material.textfield.TextInputEditText
    ...
    override fun onCreateView(
        ...
        email=root.findViewById(R.id.profile_email_2)
        val x: String = email.text.toString()
        Toast.makeText(this.context, x, Toast.LENGTH_SHORT).show()
